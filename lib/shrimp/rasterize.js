...
if (system.args.length < 3 || system.args.length > 13) {
  console.log('Usage: rasterize.js URL filename [paperwidth*paperheight|paperformat] [zoom] [margin] [orientation] [cookie_file] [render_time] [time_out] [method] [params] [content]');
  ...
  if(content !== ''){
      page.setContent(content, address);
      renderPage();
  }
  else{
